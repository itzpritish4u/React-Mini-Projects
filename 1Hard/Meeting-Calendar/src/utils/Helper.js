...
export function getMeetings() {
  ...
  for (let i = 1; i <= numMeetings; i++) {
    ...
    // end hr should be same or later than start hr
...
export function sortMeetingsByColumn(meetings) {
  meetings.sort((m1, m2) => {
...
export function getNextNonOverlappingMeeting(meetings, currentMeeting) {
  if (!currentMeeting) {
...
export function checkOverlap(m1, m2) {
